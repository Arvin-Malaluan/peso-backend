...
from .views import PostList, PostDelete, PostDetail, Comment, EngagementSetter, ResumePost, ProfilePost, ResumePut, ProfilePut, EngagementPut, CommentPut, GetAll, PWRoles, GAUWP, get_unique_users_last_three_days, get_post_with_profiles

from chat.views import create_new_message, Conversation, Messages, ConversationUpdate, ConvoDelete
...
urlpatterns = [
    ...
    path('convo-delete/<int:pk>', ConvoDelete.as_view()),
